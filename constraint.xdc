...
## Clock signal
set_property PACKAGE_PIN W5 [get_ports rawclock]
set_property IOSTANDARD LVCMOS33 [get_ports rawclock]
create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 5} [get_ports rawclock]
...
set_property PACKAGE_PIN W15 [get_ports {rad3[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {rad3[0]}]
set_property PACKAGE_PIN V15 [get_ports {rad3[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {rad3[1]}]
set_property PACKAGE_PIN W14 [get_ports {rad3[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {rad3[2]}]
set_property PACKAGE_PIN W13 [get_ports {rad3[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {rad3[3]}]
...
set_property PACKAGE_PIN U1 [get_ports {pselect[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {pselect[0]}]
set_property PACKAGE_PIN T1 [get_ports {pselect[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {pselect[1]}]
set_property PACKAGE_PIN R2 [get_ports {pselect[2]}]
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports A0]
	set_property IOSTANDARD LVCMOS33 [get_ports A0]
set_property PACKAGE_PIN W6 [get_ports B0]
	set_property IOSTANDARD LVCMOS33 [get_ports B0]
set_property PACKAGE_PIN U8 [get_ports C0]
	set_property IOSTANDARD LVCMOS33 [get_ports C0]
set_property PACKAGE_PIN V8 [get_ports D0]
	set_property IOSTANDARD LVCMOS33 [get_ports D0]
set_property PACKAGE_PIN U5 [get_ports E0]
	set_property IOSTANDARD LVCMOS33 [get_ports E0]
set_property PACKAGE_PIN V5 [get_ports F0]
	set_property IOSTANDARD LVCMOS33 [get_ports F0]
set_property PACKAGE_PIN U7 [get_ports G0]
...
set_property PACKAGE_PIN T18 [get_ports rst_signal]
	set_property IOSTANDARD LVCMOS33 [get_ports rst_signal]
set_property PACKAGE_PIN W19 [get_ports rawstep]
	set_property IOSTANDARD LVCMOS33 [get_ports rawstep]
set_property PACKAGE_PIN T17 [get_ports rawinstr]
	set_property IOSTANDARD LVCMOS33 [get_ports rawinstr]
set_property PACKAGE_PIN U17 [get_ports rawgo]
	set_property IOSTANDARD LVCMOS33 [get_ports rawgo]
...
#Pmod Header JB
# Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {cols[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {cols[3]}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {cols[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {cols[2]}]
# Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {cols[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {cols[1]}]
# Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {cols[0]}]
